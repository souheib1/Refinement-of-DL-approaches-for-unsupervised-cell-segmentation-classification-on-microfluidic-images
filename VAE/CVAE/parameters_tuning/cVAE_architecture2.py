...
class cVAE2(nn.Module):
    ...
    def __init__(self, num_labels=10, n_channels=1, convDim1=64, convDim2=128, latent_dim=16, input_size=28, kernel_size=4, beta=1, alpha = 8):
        super().__init__()
        ...
        self.linear1 = nn.Linear(latent_dim,latent_dim - latent_dim // alpha )
        self.linear2 = nn.Linear(latent_dim,latent_dim // alpha)
...
def loss_vae(beta, original, z_mean, z_log_var, reconstructed):
    ...
    # print("KL = ",KL_divergence(z_mean,z_log_var))
    return total_loss
>>>>>>> 61b1a12eda44206a83eec5925a04cbe96d1a7ec3
=======
#!/usr/bin/env python
# coding: utf-8
# @author Souheib Ben Mabrouk
